...
function createMap() {
    ...
    mymap = L.map('mapid').setView([39.152, -106.338], 11); // .setView() sets the coordinates and zoom level of the map object.
    ...
    var outdoorMap = L.tileLayer('https://tiles.stadiamaps.com/tiles/stamen_terrain/{z}/{x}/{y}{r}.{ext}', {
        minZoom: 0,
        maxZoom: 18,
...
//             // Add range input element (slider)
//             container.insertAdjacentHTML('beforeend', '<input class="range-slider" type="range">');

//             // Create a container for the buttons
//             var buttonContainer = L.DomUtil.create('div', 'button-container');

//             // Add "Back" button with SVG image
//             buttonContainer.insertAdjacentHTML('beforeend', 
//                 '<button class="step" id="reverse">' +
//                 '<img src="img/back.svg" alt="Back">' +
//                 '</button>'
//             );

//             // Add "Forward" button with SVG image
//             buttonContainer.insertAdjacentHTML('beforeend', 
//                 '<button class="step" id="forward">' +
//                 '<img src="img/forward.svg" alt="Forward">' +
//                 '</button>'
//             );
