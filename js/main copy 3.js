...
function createSequenceControls(attributes){
    ...
    //set the rest of the slider attributes
    ...
    document.querySelectorAll('.step').forEach(function(step){
        step.addEventListener("click", function(){
            ...
            if (step.id == 'forward'){
                ...
                index = index > attributes.length - 1 ? 0 : index;  // use attributes.length to get the max value
            ...
            // Optionally, you can call a function here to update the map based on the new slider value
            // updateMapWithNewIndex(index);  // You can implement this function to handle map updates
        })
    });
    ...
    document.querySelector('.range-slider').addEventListener('input', function(){
        ...
        console.log('Slider value (index):', index);
