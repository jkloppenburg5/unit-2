...
function createMap(){
    // L.map() is the function that creates the instance of the Leafelt map. 'mapid' is the identifier of the HTML element (div) that will hold the map in index.html.
