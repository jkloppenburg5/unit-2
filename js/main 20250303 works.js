...
// function calculateStats(data) {
    ...
    // console.log('Calculated maxValue:', dataStats.max); // Debug log
    //calculate meanValue
    // var sum = allValues.reduce(function(a, b){return a+b;});
    // dataStats.mean = sum/ allValues.length;
    // console.log('Calculated meanValue:', dataStats.mean); // Debug log

    // return { min: dataStats.min, max: dataStats.max, average: dataStats.mean };
...
function createLegend(attributes){
    var LegendControl = L.Control.extend({
        ...
        onAdd: function () {
            ...
            // class="leaflet-interactive" stroke="#fff" stroke-opacity="1" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="#ff7800" fill-opacity="0.3" fill-rule="evenodd" d="M428,613a21,21 0 1,0 42,0 a21,21 0 1,0 -42,0 "></path>
    ...
    fetch("data/LT100MTBnumberNoZero.geojson")
        ...
        .then(function (LT100MTBJSObject) {
            ...
            createSequenceControls(attributes);
             ...
             createLegend(attributes); // Here we call createLegend and pass the attributes
